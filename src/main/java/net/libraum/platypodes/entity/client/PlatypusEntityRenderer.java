...
public class PlatypusEntityRenderer extends MobEntityRenderer<PlatypusEntity, PlatypusEntityModel<PlatypusEntity>> {
    private static final Identifier LUCY_TEXTURE = Identifier.of(Platypodes.MOD_ID, "textures/entity/platypus/platypus_lucy.png");
    private static final Identifier WILD_TEXTURE = Identifier.of(Platypodes.MOD_ID, "textures/entity/platypus/platypus_wild.png");
    private static final Identifier GOLD_TEXTURE = Identifier.of(Platypodes.MOD_ID, "textures/entity/platypus/platypus_gold.png");
    private static final Identifier CYAN_TEXTURE = Identifier.of(Platypodes.MOD_ID, "textures/entity/platypus/platypus_cyan.png");
    private static final Identifier BLUE_TEXTURE = Identifier.of(Platypodes.MOD_ID, "textures/entity/platypus/platypus_blue.png");
